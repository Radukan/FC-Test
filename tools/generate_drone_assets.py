...
def generate():
    ...
    icon(previews[0],MOD/'graphics/icons/field-drone.png')  # Replaced by the final distinct-icon pass.
    ...
    report={'specs':specs,'files':{str(p.relative_to(ROOT)):hashlib.sha256(p.read_bytes()).hexdigest()
                                 for p in sorted(out.glob('*.png'))+[MOD/'graphics/technology/field-robotics.png',MOD/'graphics/technology/field-robotics-2.png',MOD/'graphics/technology/field-robotics-3.png']}}
