...
def generate():
    ...
    put('sn-gui','footer',f'SECOND NATURE / Nightglass   /   v{version}')
    put('sn-message','welcome',f'[Second Nature] Nightglass {version} / Press Shift + T for the field station, Ctrl + Shift + P for local smog, Shift + I for inserter vectors, Ctrl + Shift + J for the jukebox, and Ctrl + Shift + B for field construction drones. Begin with stone → silica → glass and Pioneer biology.')
