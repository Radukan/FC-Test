...
class DataStage:
    def __init__(self, upstream: Path, overhaul=True, startup_overrides=None):
        ...
        for name, value in ({'sn-opening-audio':True,'sn-inserter-vectors':True,'sn-menu-music':True,'sn-expedition-character':True,'sn-desolate-start':True,'sn-legacy-smog':80,'sn-biter-metabolism':True,'sn-menu-background':True} | (startup_overrides or {})).items():
