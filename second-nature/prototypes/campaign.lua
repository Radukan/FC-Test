...
lander.collision_box, lander.selection_box = table.deepcopy(Lander.collision_box), table.deepcopy(Lander.selection_box)
lander.drawing_box_vertical_extension = 2
lander.max_health = 5000
local lander_animation = Art.animation("lander", Lander.animation_speed)
