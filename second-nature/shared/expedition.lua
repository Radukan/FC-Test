...
item("item","alloy-stock","Mineral-composite stock",nil,"A hand-formed iron/mineral structural stock. No wood, resin, biomass, power or research required.")
item("gun","carbine","Expedition carbine","submachine-gun","Reliable early ballistic weapon. Uses ordinary bullet magazines or expedition magazines; no exotic ammo lock-in.")
item("ammo","ballistic-magazine","Expedition magazine","firearm-magazine","Ten improved ballistic rounds from iron and copper. Hand-craftable from the start.")
item("capsule","field-dressing","Sterile field dressing","raw-fish","A wood- and fish-free medical dressing. Restores health using the native consumable system; early biological processing supplies replacements.")
item("armor","field-armor","Expedition field armor","light-armor","Sturdy early protection for a woodless frontier. Your supplied suit is not a substitute for maintained defenses.")
item("ammo-turret","sentry-turret","Riveted sentry turret","gun-turret","Early mechanical perimeter defense: longer reach and tougher housing. Accepts the vanilla bullet family; it must be reloaded.")
item("wall","field-barricade","Riveted field barricade","stone-wall","Stone-filled steel panels for the first perimeter. Acid-resistant, but not invulnerable.")
item("gun","induction-rifle","Induction rifle","submachine-gun","Mid-game precision electrical weapon. Battery-fed cells trade rate of fire for range and armor-penetrating electric damage.")
item("ammo","induction-cell","Induction cell","firearm-magazine","Ten electrical shots. Rechargeable industry supplies the batteries; spent cells are consumed, not conjured back into existence.")
item("electric-turret","arc-turret","Capacitor arc turret","laser-turret","Mid-game electrical defense. Demands a substantial power supply and a charged buffer; outages leave gaps in the perimeter.")
item("wall","composite-wall","Composite bastion wall","stone-wall","Steel and biological composite reinforcement. More expensive, with stronger physical and acid protection.")
item("armor","expedition-armor","Powered expedition armor","modular-armor","Mid-game modular protection with a six-by-six equipment grid. Uses ordinary equipment and real electrical supply.")
item("gun","lance-rifle","Heavy lance rifle","railgun","Late-game magnetic lance. Uses the railgun ammo family; line attacks can damage friendly infrastructure. Aim deliberately.")
item("ammo","lance-cell","Dense-core lance round","railgun-ammo","A costly, dense-core rail round for endgame threats. Line damage can strike more than the first target.")
item("ammo-turret","lance-turret","Bastion lance turret","railgun-turret","Late-game heavy defense against armored targets. Requires rail ammunition and its native electrical support; keep firing lanes clear.")
item("armor","bastion-armor","Bastion expedition armor","power-armor-mk2","Late-game expedition armor with a ten-by-ten equipment grid. Strong defenses still require powered equipment.")
item("energy-shield-equipment","ecoshield-equipment","Biosphere shield module","energy-shield-mk2-equipment","A high-capacity powered personal shield. It draws real equipment-grid energy; no passive invulnerability.")
