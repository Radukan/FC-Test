![Nightglass - original warden, solar railway and power sprites](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/art/nightglass-review.jpg)
...
See [WARDEN.md](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/WARDEN.md) and [ASSET-SIZE.md](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/ASSET-SIZE.md).
...
[Medallion sheet](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/art/achievement-review.jpg) · [Milestones, field guide and soundscape](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/MILESTONES.md)
...
This described the explorer model that 0.11.0 removed. The character is now the sealed Restoration Warden; see [WARDEN.md](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/WARDEN.md).
...
[Power roster, costs and scaling examples](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/POWER-ROSTER.md) · [Icon comparison sheet](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/art/icon-review.jpg) · [Power animation study](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/art/power-options-preview.gif) · [Warden movement](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/art/locomotion-review.gif)

### Solar railway retained

The Sunseed, Heliograph and Daybreak locomotives remain solar-only, with locked onboard panels/batteries and day/night ceilings of 91/48, 147/91 and 194/130 km/h respectively. No ordinary fuel or factory-grid charging is accepted. Empty batteries provide no traction. Open a locomotive's GUI for its onboard energy monitor. See [the solar-energy contract](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/NIGHTGLASS.md).
...
[Field crew overview](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/art/field-crew-review.jpg) · [3D drone motion study](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/art/field-drone-preview.gif) · [Movement](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/art/locomotion-review.gif) · [Mining grip](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/art/mining-framing-preview.gif) · [Controls and safeguards](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/FIELD-CREW.md)
...
[Building contact sheet](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/art/ironbound-contact-sheet.jpg) · [Locomotion review](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/art/locomotion-review.gif) · [Mining review](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/art/mining-framing-preview.gif)
...
[Ship study](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/art/lander-review.jpg) · [Standby animation](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/art/lander-standby.gif) · [Continuation audit](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/CONTINUATION-AUDIT.md)
...
This is an **alpha**, not a claim of a completed balanced campaign. [Verification ledger](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/VERIFICATION.md) distinguishes offline/source tests, actual headless checks and outstanding graphical/full-game/multiplayer work. Releases require real stable-engine validation and a re-download/checksum comparison.

- [Full catalog](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/CATALOG.md) · [Balance equations](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/BALANCE.md) · [Model-only timing](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/SIMULATION.md)
- [Milestones, field guide and soundscape](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/MILESTONES.md) · [Power roster](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/POWER-ROSTER.md)
- [Campaign design](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/DESIGN.md) · [Development and art regeneration](https://github.com/Radukan/FC-Test/blob/v0.11.0-factorio-2.0/docs/DEVELOPING.md)
